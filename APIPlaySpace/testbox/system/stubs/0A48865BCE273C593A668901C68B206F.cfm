<cfscript>
			variables[ "getHTTPMethod" ] = variables[ "tmp_getHTTPMethod_0A48865BCE273C593A668901C68B206F" ];
			this[ "getHTTPMethod" ]           = variables[ "tmp_getHTTPMethod_0A48865BCE273C593A668901C68B206F" ];
			// Clean up
			structDelete( variables, "tmp_getHTTPMethod_0A48865BCE273C593A668901C68B206F" );
			structDelete( this, "tmp_getHTTPMethod_0A48865BCE273C593A668901C68B206F" );

			public string function tmp_getHTTPMethod_0A48865BCE273C593A668901C68B206F( 

			) output=true {
 
			var results                 = this._mockResults;
			var resultsKey           = "getHTTPMethod";
			...
			arrayAppend(this._mockCallLoggers["getHTTPMethod"], arguments);
