<cfscript>
			variables[ "getCGIElement" ] = variables[ "tmp_getCGIElement_53401CF0B55D2CE6B48B52E9AB39CE6E" ];
			this[ "getCGIElement" ]           = variables[ "tmp_getCGIElement_53401CF0B55D2CE6B48B52E9AB39CE6E" ];
			// Clean up
			structDelete( variables, "tmp_getCGIElement_53401CF0B55D2CE6B48B52E9AB39CE6E" );
			structDelete( this, "tmp_getCGIElement_53401CF0B55D2CE6B48B52E9AB39CE6E" );

			public any function tmp_getCGIElement_53401CF0B55D2CE6B48B52E9AB39CE6E( 

			) output=true {
 
			var results                 = this._mockResults;
			var resultsKey           = "getCGIElement";
			...
			arrayAppend(this._mockCallLoggers["getCGIElement"], arguments);
