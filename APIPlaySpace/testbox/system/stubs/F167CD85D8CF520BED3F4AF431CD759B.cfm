<cfscript>
			variables[ "setHTTPHeader" ] = variables[ "tmp_setHTTPHeader_F167CD85D8CF520BED3F4AF431CD759B" ];
			this[ "setHTTPHeader" ]           = variables[ "tmp_setHTTPHeader_F167CD85D8CF520BED3F4AF431CD759B" ];
			// Clean up
			structDelete( variables, "tmp_setHTTPHeader_F167CD85D8CF520BED3F4AF431CD759B" );
			structDelete( this, "tmp_setHTTPHeader_F167CD85D8CF520BED3F4AF431CD759B" );

			public any function tmp_setHTTPHeader_F167CD85D8CF520BED3F4AF431CD759B( 

			) output=true {
 
			var results                 = this._mockResults;
			var resultsKey           = "setHTTPHeader";
			...
			arrayAppend(this._mockCallLoggers["setHTTPHeader"], arguments);
